...
Nothing you do here is destructive. There are three ways back, and which one you want depends on
one thing only: **whether you have pressed Save yet.**

### Before you save

Every box has a **⋮** beside it. Open it and choose **Revert Changes** and that box goes back to
what it was, leaving everything else alone.

![An edit, and the way back out of it](images/07-undo.png)

The **⋮** at the top of the form has **Revert All Changes**, which does the same for the whole
section at once.

Nothing has left your browser at this point. The website has not changed and nobody has seen
anything.

### Save is the line

Until you press Save, your website is exactly as it was. After you press Save, the change is
recorded and the site rebuilds.

That is the whole difference between the two kinds of undo. **Revert** is for a change you have not
saved. **History** is for one you have.

### After you save

The clock icon on the right of a section shows every saved version of it, who saved it and when.

![The history of one section](images/08-history.png)

Nothing is ever thrown away, so a change you regret an hour later, or a month later, is still
there to go back to. If you want a version restored, tell me which one and when — that is a
two-minute job and there is no way to lose the wrong thing doing it.

### If you close the editor mid-edit

Unsaved changes are kept in your own browser, not on the website. Next time you open that section
the editor will notice them and ask whether you want to **restore** them or **discard** them.

- **Restore** puts your half-finished edit back so you can carry on.
- **Discard** throws it away and gives you the section as it is published.

Neither answer can hurt anything: the published site was never touched either way. And if you
answer on a different computer, or a different browser, there will be nothing to ask about — those
unsaved changes live only where you made them.
...
### All Assets, and why to leave it alone

The picture icon at the very top left opens **All Assets** — every file on your site in one list.

![All Assets: every picture at once, with nothing saying where any of them is used](images/06-all-assets.png)

It is worth knowing it exists, and it is the wrong place to work.

Look at that list. Three of those are photographs of you, with names that mean nothing:
`john-about.webp`, `john-cutout.webp`, `john-goss.webp`. One is the picture you uploaded, one is
what the site made from it for the top of the page, and one is the photograph further down. Nothing
on the screen tells you which is which, and there is a **Delete** button on the same bar.

**So change pictures through the forms instead.** Open **Home → Hero** and you can see the
photograph sitting in the field it belongs to, with its own label, and replacing it there replaces
exactly that one. The picture is shown next to the words it goes with, which is the thing All
Assets cannot do.

Use All Assets to look. Use the forms to change.
...
- **Picture** and **Picture description** — both optional. See chapter 6.
...
## 9. Editing from your phone

The editor works on a phone, and there is a shortcut so you do not have to type a password into a
small keyboard.

On the computer, click your picture in the top right and choose **Sign In with Mobile**. A square
black-and-white code appears. Point your phone's camera at it and the phone opens the editor
already signed in.

![The account menu: signing in on a phone, and signing out](images/09-account-menu.png)

That code is a key to your website for as long as it is on screen. Do not photograph it, do not
send it to anyone, and close it once your phone has read it. If someone else is in the room, it can
wait.

**Sign out when you have finished, every time — on the phone especially.** Same menu, **Sign Out**
at the bottom. A phone gets lent, left on a table, and looked at over a shoulder far more than a
computer does, and a signed-in editor is the keys to your website. Signing back in is three taps.
